...
public class XA {
    ...
    //--------LOGIN URL-------//
    public static final byte[] A = {59,
            -40,122,-84,123,-118,-117,-94,-45,111,102,24,51,67,5,-38,
            -28,54,-87,-45,87,-29,48,17,-126,-40,46,-92,-128,-75,-106,
            -98,82,-72,-15,-57,41,-122,-59,115,40,76,-41,125,-35,-16,
            -100,-78};
    ...
    public static final byte[] AA = {59,
            -40,122,-84,123,-118,-117,-94,-45,111,102,24,51,67,5,-38,
            -28,54,-87,-45,87,-29,48,17,-126,-40,46,-92,-128,-75,-106,
            -98,-56,-62,-90,-4,-119,-66,57,-6,-123,-1,53,11,-125,15,
            86,-57};
    ...
    //--------IMG URL-------//
    public static final byte[] C = {59,
            -40,122,-84,123,-118,-117,-94,-45,111,102,24,51,67,5,-38,
            -28,54,-87,-45,87,-29,48,17,-126,-40,46,-92,-128,-75,-106,
            -98,-51,-31,9,-116,116,82,-80,-50,93,-123,52,100,95,21,
            47,-96,113,55,120,86,25,58,54,-70,39,-93,79,-90,81,
            -83,29,-101};
    ...
    public static String b(byte[] eb) {
        ...
        try {
            ...
            Log.d("DECHIP_ERROR", e.getMessage());
            if (b.equals(A))
                Log.d("DECHIP_ERROR", "A");
            if (b.equals(B))
                Log.d("DECHIP_ERROR", "B");
            if (b.equals(AA))
                Log.d("DECHIP_ERROR", "AA");
            if (b.equals(C))
                Log.d("DECHIP_ERROR", "C");
            if (b.equals(MA))
                Log.d("DECHIP_ERROR", "MA");
            if (b.equals(EA))
                Log.d("DECHIP_ERROR", "EA");
        }
        return b;
    }
